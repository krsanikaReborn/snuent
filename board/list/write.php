...
?>
						...
						<script>
							...
							function uploading(f){
								...
								else if(f.captchaString.value == '') { alert('자동등록방지 문자를 입력하십시오.'); f.captchaString.focus(); return false; }
								return true;
							}
							
							function captchaRefresh(){
								document.getElementById('captchaImage').src = '/inc/captcha.php?v=' + Math.random();
								return false;
							}
/*
							function uploading(f){
